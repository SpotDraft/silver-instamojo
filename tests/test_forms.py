...
from silver_instamojo.forms import InstamojoTransactionFormBase
...
@patch('silver_instamojo.forms.datetime')
def test_instamojo_transaction_form_build_body(mocked_datetime, transaction,
                                          payment_method):
    ...
    with patch('silver.utils.payments._get_jwt_token') as mocked_token:
        ...
        form = InstamojoTransactionFormBase(payment_method, transaction, {})
